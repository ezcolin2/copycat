...
function appendGameData(videoElement) {
    console.log('게임 데이터 추가')
    var gameData = document.createElement('div');
    gameData.className = "game-data";
    gameData.id = "data-" + nodeId;
    gameData.innerHTML = '<p class="nickName">' + "hello" + '</p><p class="userName">' + "hello" + '</p>';
